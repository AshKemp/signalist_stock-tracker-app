    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <InputField name="email" label="Email" placeholder="contact@jsmastery.com" register={register} error={errors.email}
                            validation={{required: 'Email is required', pattern: /^\w+@\w+\.\w+$/, message: 'Email address is required'}}/>
                <InputField name="password" label="Password"  type={"password"} placeholder="Enter a strong password" register={register} error={errors.password}
